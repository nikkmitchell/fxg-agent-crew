...
| 16b | Point at a panel with a hand or a controller | The pointer ray and its dot are faint (10%). Settings → Room: **− Pointer dimmer** and **+ Pointer brighter** step it from off to 100%, changing at once; tapping **Pointer brightness** turns it off and back on at 10%. Pinching and pressing still work with it off. | Nothing changes until you re-enter; at off you can no longer press anything. |
